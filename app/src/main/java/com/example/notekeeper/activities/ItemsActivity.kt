...
class ItemsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.appBarItems.contentItems.listItems.layoutManager = LinearLayoutManager(this)
        binding.appBarItems.contentItems.listItems.adapter       = NoteRecyclerAdapter(this, DataManager.notes)
